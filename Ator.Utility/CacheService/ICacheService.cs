...
namespace Ator.Utility.CacheService
{
    public interface ICacheService
    {
        ...
        /// <returns></returns>
        bool Add(string key, object value, int expiresSliding, int expiressAbsoulte);
        ...
        /// <returns></returns>
        bool Add(string key, object value, int expiresIn, bool isSliding = false);
        ...
        /// <param name="expiressAbsoulte">绝对过期时长</param>
        /// <returns></returns>
        bool Replace(string key, object value, int expiresSliding, int expiressAbsoulte);
        ...
        /// <param name="isSliding">是否滑动过期（如果在过期时间内有操作，则以当前时间点延长过期时间）</param>
        /// <returns></returns>
        bool Replace(string key, object value, int expiresIn, bool isSliding = false);
